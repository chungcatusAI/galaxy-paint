...
$(document).on('click', '.product-list1', function () {
    return false;
...
$(document).on('click', '.product-all-list1', function () {
    return false;
...
$(document).on('click', '.product-list2', function () {
    return false;
    var category = $(this).data('id');
    $.ajax({
        url: loadProduct,
...
$(document).on('click', '.product-all-list2', function () {
    return false;
    var category = $(this).data('value');
    $.ajax({
        url: loadAllProduct,
