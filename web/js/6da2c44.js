...
$(document).ready(function () {
  ...
  $(window).load(function() {
      ...
      /* $('.carousel-result-filter').flexslider({
           animation: "slide",
           controlNav: false,
           animationLoop: false,
           slideshow: false,
      ...
      $('.carousel-result-agency').owlCarousel({
          margin: 10,
          items: 2,
          autoWidth: true,
          autoHeight: true,
      ...
      $('.carousel-result-painter').owlCarousel({
          margin: 10,
          items: 2,
          autoWidth: true,
          autoHeight: true,
  ...
  $('.slide-list-painter').owlCarousel({
      margin: 10,
      items: 2,
      autoWidth: true,
      autoHeight: true,
...
$('.slide-list-landing').owlCarousel({
        center: true,
        margin: 10,
        items:3,
        loop:true,
  ...
  $('.carousel-result-filter').owlCarousel({
      margin: 10,
      items: 2,
      autoWidth: true,
      autoHeight: true,
...
$('.autowidth-promotion').owlCarousel({
        auto: true,
        margin:35,
        autoHeight: true,
        loop:true,
    ...
    $('.autowidth-promotion-right').owlCarousel({
        auto: true,
        margin:35,
        autoHeight: true,
        loop:true,
  ...
  $('.slide-news-detail, .slide-customer-rate, .slideshow-image').owlCarousel({
      loop:true,
      items:1,
      nav: true,
      navText: ['<i class="fa fa-angle-left"></i>', '<i class="fa fa-angle-right"></i>'],
  ...
  $('.btn-rule').click(function () {
    $('.modal-rule-show').addClass('show');
    $('body').addClass('no-scroll');
  });

  $('.reg-painter').click(function () {
    $('.modal-reg-paint').addClass('show');
    $('body').addClass('no-scroll');
  });

  $('.score-history').click(function () {
    $('.modal-accumulated-score').addClass('show');
    $('body').addClass('no-scroll');
  });

  $('.btn-type-score').click(function () {
    $('.type-score-modal').addClass('show');
    $('body').addClass('no-scroll');
  });

  $('.btn-code-promo').click(function () {
    $('.code-promo-modal').addClass('show');
    $('body').addClass('no-scroll');
  });

  $('.btn-get-rs').click(function () {
    $('.modal-get-result').addClass('show');
    $('body').addClass('no-scroll');
  });

  $('.btn-save-pf').click(function () {
    $('.modal-your-profile').addClass('show');
    $('body').addClass('no-scroll');
  });

  $('.btn-ac-pf').click(function () {
    $('.edit-profile-md').addClass('show');
    $('body').addClass('no-scroll');
  });

  $('.escape-modal, .close-modal').click(function () {
    $('.modal-user, .popup-pro-modal, .edit-profile-md, .modal-rule-show, .modal-your-profile, .modal-reg-paint, .modal-get-result, .modal-accumulated-score, .type-score-modal, .code-promo-modal').removeClass('show');
  ...
  $(".slide-news-detail .owl-nav div").click(function() {
      $('html, body').animate({
          scrollTop: $("#news-detail").offset().top
      }, 1000);
  });

  $("#modal-step1").on("shown.bs.modal",function(){
    $('.slide-color-modal').owlCarousel({
        margin:7,
        loop:true,
        autoWidth:true,
        items:4,
  ...
  $("#modal-step3").on("shown.bs.modal",function(){
    
      $('.carousel-filter-paint').flexslider({
          animation: "slide",
          controlNav: false,
          animationLoop: false,
          slideshow: false,
      ...
      $('.carousel-result-agency-md').owlCarousel({
          items:5,
          margin: 40,
          autoHeight: true,
          autoWidth: true,
  ...
  $("#modal-step4").on("shown.bs.modal",function(){
    
      $('.carousel-filter-md').flexslider({
          animation: "slide",
          controlNav: false,
          animationLoop: false,
          slideshow: false,
      ...
      $('.carousel-result-painter-md').owlCarousel({
          items:5,
          autoHeight: true,
          margin: 40,
          autoWidth: true,
  ...
  $(document).keyup(function(e) {
      if (e.keyCode == 27) { // escape key maps to keycode `27`
        $('.modal-user, .popup-pro-modal, .edit-profile-md, .modal-your-profile, .modal-get-result, .modal-rule-show, .modal-reg-paint, .modal-accumulated-score, .type-score-modal').removeClass('show');
        $('body').removeClass('no-scroll');
        $('.light-box-search').removeClass('show-search');
        $(".popup-success").fadeOut(400);
        $('.close-pp').parent().fadeOut('fast');
      }
  });
  ...
  // $(".box-detail h3 a").text(function(index, currentText) {
  ...
  $('.radio-style').click(function() {
      if($('.clk-radioshow').is(':checked')) {
        if ($('.step-box').find('.radio-show').is(':visible')) {
            $('.radio-show').slideUp(400);
        }
        $(this).next().slideDown(400);
      }
  });
  
  /*$('.carousel-filter li').on('click', function () {
    if($('.carousel-filter').find('li').hasClass('active')) {
      $('.carousel-filter li').removeClass('active');
    }
    $(this).addClass('active');
  });*/
  
  $('.carousel-filter div').on('click', function () {
    if($('.carousel-filter').find('div').hasClass('active')) {
      $('.carousel-filter div').removeClass('active');
    }
    $(this).addClass('active');
  });
  ...
  var youtubePlayer;
      ...
      $(".video-promo-watch").on("click", function(e) {
        ...
        setTimeout(function() {
            ...
            $("#youtube-promo-video")[0].src += "&autoplay=1";
        }, 400);
      });
      ...
      $(".video-promo-video-close").on("click", function(e) {
        ...
        // $("#youtube-promo-video")[0].src += "&autoplay=0";
        var videoURL = $('#youtube-promo-video').prop('src');
        videoURL = videoURL.replace("&autoplay=1", "");
        $('#youtube-promo-video').prop('src','');
        $('#youtube-promo-video').prop('src',videoURL);
      });
...
function clickLuckyPainter()
{
    $('#register-active').addClass('active');
...
function clickLogin()
{
    $('#login-active').addClass('active');
    $('#register-active').removeClass('active');
    $('#profile-active').removeClass('active');
    $("#tab2").tabs().hide();
    $("#tab3").tabs().hide();
    $("#tab1").show();
...
$(function () {
    $('.product-list1, .product-list2, .product-all-list1, .product-all-list2').attr('href', 'javascript:void(0);');
});
$(document).on('click', '.product-list1', function (e) {
    e.preventDefault();
    return false;
    ...
    $.ajax({
        ...
        $('.load-product-list1').html(data['content']);
        $('.carousel-result-filter').owlCarousel({
            autoWidth: true,
            autoHeight: true,
            items:2,
        ...
        alert('Danh muc: ' + category);
    });
});

$(document).on('click', '.product-all-list1', function (e) {
    e.preventDefault();
    return false;
...
$(document).on('click', '.product-list2', function (e) {
    e.preventDefault();
    return false;
    var category = $(this).data('id');
    $.ajax({
        ...
        var data = $.parseJSON(resp);
        $('.load-product-list2').html(data['content']);
        $('.carousel-result-filter').owlCarousel({
            autoWidth: true,
            autoHeight: true,
            items:2,
...
$(document).on('click', '.product-all-list2', function (e) {
    e.preventDefault();
    return false;
    var category = $(this).data('value');
    $.ajax({
